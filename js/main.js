...
function resetForm() {
    for (var i = 0; i < inputs.length; i++) {
        ...
        alerts[i].classList.remove("d-block");
        alerts[i].classList.add("d-none");
        
    }

    // productName.classList.remove("is-invalid");// productName.classList.remove("is-valid");// PNameAlert.classList.remove("d-block");// PNameAlert.classList.add("d-none");
    // productCategory.classList.remove("is-valid");// productCategory.classList.remove("is-invalid");// PCategoryAlert.classList.remove("d-block");// PCategoryAlert.classList.add("d-none");
    // productPrice.classList.remove("is-valid");// productPrice.classList.remove("is-invalid");// PPriceAlert.classList.remove("d-block");// PPriceAlert.classList.add("d-none");
    // productDescription.classList.remove("is-invalid");// productDescription.classList.remove("is-valid");// PDescriptionAlert.classList.remove("d-block");// PDescriptionAlert.classList.add("d-none");
};


//Delete Product From Table & Storage Function:
